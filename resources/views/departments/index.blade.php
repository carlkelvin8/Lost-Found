...
{{-- Alerts --}}
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h1 class="h4 fw-bold mb-0">Departments</h1>
            <div class="text-muted small">Manage departments</div>
        </div>
        <div class="d-flex gap-2">
            <a class="btn btn-sm btn-primary" href="{{ route('departments.create') }}">
            ...
            <table class="table table-striped align-middle mb-0">
                ...
                @forelse($departments as $row)
                    <tr>
                        ...
                        <td>{{ $row->name }}</td>
                        <td class="text-end">
                            <a class="btn btn-sm btn-outline-secondary" href="{{ route('departments.edit', $row->id) }}">
