  ...
  <div class="form-card-body">
    <div class="row g-3">
      ...
      <div class="col-12 col-md-6">
        ...
        <input class="form-control" name="latitude" value="{{ old('latitude') }}" placeholder="e.g. 14.5995" />
        <div class="form-text">Range: -90 to 90. North (positive) or South (negative) position on the globe.</div>
      </div>
      <div class="col-12 col-md-6">
        <label class="form-label">Longitude</label>
        <input class="form-control" name="longitude" value="{{ old('longitude') }}" placeholder="e.g. 120.9842" />
