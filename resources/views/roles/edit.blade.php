...
@endif
  ...
  <h1 class="h4 fw-bold mb-0">Edit Role</h1>
  <a class="btn btn-sm btn-outline-secondary" href="{{ route('roles.index') }}"><i class="bi bi-arrow-left"></i> Back</a>
</div>

<form method="POST" action="{{ route('roles.update', $role->id) }}" class="card shadow-sm">
  @csrf
